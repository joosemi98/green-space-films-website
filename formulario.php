                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="languageDropdown">
                            <a class="dropdown-item" href="index.html"><img src="espana.png" alt="Español" height="20" width="20"> Español</a>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <form id="consulta1" action="enviar_correo.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="msg">Déjanos tu mensaje:</label>
                            <textarea id="msg" name="mensaje" class="form-control" rows="6"></textarea>
                        </div>
                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="conforme" name="conforme">
                            <label class="form-check-label" for="conforme">Acepto los términos y condiciones</label>
                        </div>
